          ...
          <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-gray-700 mb-4">
                Semua berawal dari cinta kami terhadap keindahan alami. Pada
                tahun 2006, dari sebuah toko kecil yang penuh harapan, kami
                mulai merangkai bunga untuk momen-momen paling berarti dalam
                hidup. Dari ulang tahun, pernikahan, hingga ucapan simpati —
                kami percaya bahwa bunga adalah bahasa paling tulus yang bisa
                disampaikan.
              </p>
              <p className="text-gray-700">
                Kini, kami tumbuh menjadi salah satu toko bunga terpercaya,
                namun tetap setia pada akar kami: merangkai dengan ketulusan dan
                menyentuh hati lewat keindahan.
              </p>
              <p className="text-gray-700">
                Setiap tangkai bunga kami pilih dengan hati, dan setiap
                rangkaian kami buat dengan cinta. Tim kami terdiri dari
                tangan-tangan terampil yang memahami bahwa setiap bunga membawa
                pesan, dan setiap pesan layak sampai dengan indah.
              </p>
              <p className="text-gray-700">
